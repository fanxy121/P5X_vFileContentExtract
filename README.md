...
准备好PS3模拟器下可运行P5游戏本体  
第一步,用工具[CriPakGUI](http://www.k73.com/down/soft/242290.html) 打开游戏本体下data.cpk文件,创建提取文件夹。  
第二步,解包目录下data.cpk_unpacked\model\character角色类目,GMD文件是各类皮肤(泳装/便服/怪盗服)Event类动画文件夹、需用[GFD.Studio](https://github.com/tge-was-taken/GFD-Studio/releases)软件打开GMD格式文件，然后拖入动画文件点击查看。  
第三步,用建模软件进一步修改编辑渲染。  
